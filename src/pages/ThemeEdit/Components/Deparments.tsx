  ...
  return (
    <div className='departments_super'>
      <div className='upper_departments'>
        <input type="text" placeholder='Search Department...' onChange={(e)=>{setFilter(e.target.value)}}/>
        <motion.button 
        ...
        onClick={()=>{setNewDep(true)}}>
          <AddIcon   style={{color: companyData.themeColors.secondary}} className='icon'/>
        </motion.button>
      </div>
      <motion.div 
      ...
      className='departments_container'>
             ...
             <div>
              <div className='add_buttonsCont'>
                ...
                if(addedDep === ''){
                  ...
                  dispatch(setCompanyData({...companyData,
                    departments: [{_id:  Date.now().toString(), name: addedDep}, ...companyData.departments] }))
                }}
                }
        ...
        {companyData.departments.filter((department)=>{
        ...
        .map(department =>{
          ...
          <div className='depatments_depart' key={department._id}>
            ...
            <button className='button_deleteDepartment' onClick={()=>{
      ...
      className='button_seveDept' >Save Changes</button>
    </div>
  )
}
