  ...
  return (
    ...
    <div className='super'>
      ...
      <div className='claim_id'>
        ...
        className='title' >Description</h1>
        ...
        <div className='claim_description'>
            <div className='desc' >
            {claim.message}
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, earum animi! Ab illo, autem praesentium modi eius dicta ut ea culpa recusandae commodi deleniti fugit tempore corrupti. In, ipsum optio!
            Lorem ipsum dolor sit  consectetur adipisicing elit. Aut nisi possimus incidunt commodi dignissimos animi eaque ullam quos placeat veritatis alias inventore unde asperiores aperiam, fugit corporis reprehenderit error laboriosam.
            Lorem ipsum dolor sit  consectetur adipisicing elit. Aut nisi possimus incidunt commodi dignissimos animi eaque ullam quos placeat veritatis alias inventore unde asperiores aperiam, fugit corporis reprehenderit error laboriosam.
        ...
        <div className='extras'>
          ...
          <div className='extra extra_rigth'>
            <p className='titles_extras' style={{color: companyData.themeColors.primary, fontWeight: 'bolder'}}>Members</p>
